...
class SignUpFormBase extends Component {
  ...
  onSignin = event => {
    event.preventDefault();
    //console.log("hello1");
    if(this.state.email_si===''||this.state.password_si==='')
    alert("enter all required fields");
    else
      ...
      <form class="form form-login" onSubmit={this.onSignin}>
        <fieldset>
          ...
          <div class="input-block">
            ...
            <input id="login-email" name="email_si" onChange={this.onChange} type="email" />
          </div>
          <div class="input-block">
            <label for="login-password">Password</label>
            <input id="login-password" name="password_si" onChange={this.onChange} type="password" />
          </div>
        </fieldset>
      ...
      <form class="form form-signup" onSubmit={this.onSubmit}>
        <fieldset>
          ...
          <div class="input-block">
            ...
            <input id="signup-password" name="password" onChange={this.onChange} type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"/>
          </div>
        </fieldset>
