            ...
            <>
                ...
                <div className="ipbox">
                    <Form onSubmit={this.handleSubmit.bind(this)} className="w-100">
                        <Form.Group className="mb-1" controlId="stdin1">
                            <Form.Label><strong className="text-white">Input (stdin)</strong></Form.Label>
                            <Form.Control onChange={this.handleStdin.bind(this)} name="stdin1" as="textarea" rows="4" className="bg-dark border-secondary text-white" />
                        </Form.Group>
